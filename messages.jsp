<%-- 
    Document   : messages
    Created on : Jan 30, 2019, 2:52:05 PM
    Author     : user
--%>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<link href="//fonts.googleapis.com/css?family=Poppins:200,200i,300,300i,400,400i,500,500i,600,600i,700" rel="stylesheet">
        ...
        <script type="text/javascript">
           function check(){ 
               var d=document.getElementById("dlr").value;
            if(d=="select")           
            {                 
    ...
    <body>
		...
		<div class="donate-inner">
                    ...
                    <div class="col-md-8 donate-info"><br><br><br><br><br><br>
                        <center><h4>Message To Dealer </h4></center><br>
                        <form action="msgServlet" method="post" onsubmit="return check()">
        <%
           Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            String url="jdbc:sqlserver://localhost:1433;databaseName=safalam;user=sa;password=password123";
            
            String q="select name from adddealer";
            Connection con=DriverManager.getConnection(url);
            Statement ps=con.createStatement();
            ResultSet rs=ps.executeQuery(q);
           
        %>   
        Dealer&nbsp;&nbsp;&nbsp;  <select name="dlr" id="dlr"><option value="select">select</option>
            <%
                 while(rs.next()){
            %>    
        ...
        Message <textarea name="msg" rows="4" cols="40" required>
