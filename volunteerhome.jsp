<%-- 
    Document   : volunteerhome
    Created on : Feb 26, 2019, 3:06:34 PM
    Author     : User
--%>
						...
						<ul class="nav navbar-nav">
							<li class="active">
								<a href="dealerhome.jsp">Home</a>
                                                         ...
                                                         <li>
								<a class="scroll" href="viewupdates1.jsp">View Updates</a>
							</li>
							
                                                        <li>
								<a class="scroll" href="viewvolmsg.jsp">View Messages</a>
