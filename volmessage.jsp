<%-- 
    Document   : volmessage
    Created on : Feb 2, 2019, 1:15:47 PM
    Author     : user
--%>
       ...
       <div class="top_header" id="home">
		...
		<div class="donate-inner">
                    ...
                    <div class="col-md-8 donate-info"><br><br><br><br>
                        <center><h4>Message To Volunteer </h4></center><br>
        <form action="msgvolServlet" method="post">
        <%
           Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            String url="jdbc:sqlserver://localhost:1433;databaseName=safalam;user=sa;password=fathima";
            
            String q="select name from addvolunteer";
            Connection con=DriverManager.getConnection(url);
            Statement ps=con.createStatement();
            ResultSet rs=ps.executeQuery(q);
           
        %>   
        Volunteer &nbsp; <select name="dlr"><option value="">select</option>
            <%
                 while(rs.next()){
            %>    
        ...
        Message<br> <textarea name="msg" rows="8" cols="40">
