<%-- 
    Document   : Viewupdates
    Created on : 29 Dec, 2018, 12:25:40 PM
    Author     : student
--%>
    ...
    <body>
			...
			<div class="nav_top_fx_w3layouts_agileits">
				<div class="navbar-header">
					...
					<div class="logo_wthree_agile">
						<h1>
							<a class="navbar-brand" href="admion.jsp">
        ...
        <div class="banner_bottom donate-log">
            <div class="donate-inner"><br><br>
                <center><h3>News Updation</h3></center><br><br>
        <form action="lateServlet" method="post">
        <table style="width:80%; column-gap:10px;">
            <tr>
        ...
        <tr>
                ...
                <td><textarea name="desc" rows="6" cols="40"  required="">
                    </textarea></td>
        </tr>
        <tr>
                <td></td>
