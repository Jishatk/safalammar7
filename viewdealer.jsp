<%-- 
    Document   : viewdealer
    Created on : Feb 7, 2019, 12:57:48 PM
    Author     : STUDENTS
--%>
    ...
    <body>
        ...
        <div class="banner_bottom donate-log">
            <div class="donate-inner"><br><br><br><br><br><br>
                        ...
                        <center><h4>Dealer Info</h4></center><br>	
                        <table id="tbl">
            <tr><th>Name</th><th>Gender</th><th>Dob</th><th>Bloodgroup</th><th>Address</th><th>Postcode</th><th>District</th><th>Mobile</th><th>Email id</th><th>Charity Club Member</th><th>About you</th><th>Dealer ID</th></tr>  
                     <%
            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            String url="jdbc:sqlserver://localhost:1433;databaseName=safalam;user=sa;password=password123";
            
            String q="select * from adddealer";
            Connection con=DriverManager.getConnection(url);
            Statement ps=con.createStatement();
            ResultSet rs=ps.executeQuery(q);
            while(rs.next()){
                        %>
            <tr><td><%=rs.getString("name")%></td><td><%=rs.getString("gender")%></td><td style="width:120px"><%=rs.getString("dob")%></td><td><%=rs.getString("bloodgroup")%></td><td><%=rs.getString("address")%></td><td><%=rs.getString("postcode")%></td><td><%=rs.getString("district")%></td><td><%=rs.getString("mobile")%></td><td><%=rs.getString("email")%></td><td><%=rs.getString("areyou")%></td><td><%=rs.getString("about")%></td><td><%=rs.getString("dlrid")%></td></tr>
         <% } %>
        </table>
