<%-- 
    Document   : addvolunteer
    Created on : 29 Dec, 2018, 2:32:59 PM
    Author     : student
--%>
    ...
    <body>
		...
		<div class="donate-inner">
                    ...
                    <div class="col-md-8 donate-info"><br><br><br><br>
                        <center><h4>Volunteer Account</h4></center><br>
        ...
        <table>
         ...
         <tr>
            ...
            <td><input type="radio" name="gender" value="male" required/>Male<input type="radio" name="gender" value="female" />Female<input type="radio" name="gender" value="others" />others</td>
                ...
                <td><input type="date" name="date" min="1940-10-20" max="2001-10-20" required /></td>
        </tr>
                 <tr>
        ...
        <tr>
                <td><label >Are you member of any charity club</label></td>
